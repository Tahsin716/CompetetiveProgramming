...
public class Beginner_1311 {
    ...
    static class Task {
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            ...
            int testCase;
            double v1, v2, v3, a1, a2, distanceTrain1, distanceTrain2, timeTrain1, timeTrain2, distance, birdDistance;
            ...
            for (int i = 1; i <= testCase; i++) {
                ...
                distanceTrain1 = (v1 / 2) * timeTrain1;
